...
const Suggestions = () => {
  ...
  if (videosError) return <p className="error">Error loading videos: {videosError.message}</p>;
  if (meError) return <p className="error">Please log in to view the song suggestions</p>;
